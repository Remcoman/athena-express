...
module.exports = class AthenaExpress {
    constructor(init) {
        ...
        this.config = {
            ...
            maxReuseResultsAge: Number(init.maxReuseResultsAge) || 0,
    ...
    async query(query) {
        ...
        if (typeof query === "object") {
            ...
            if (loweredCaseKeys.hasOwnProperty("maxreuseresultsage")) {
                config.maxReuseResultsAge = loweredCaseKeys.maxreuseresultsage;
            }
            if (loweredCaseKeys.hasOwnProperty("executionparameters")) {
                config.executionParameters = loweredCaseKeys.executionparameters;
            }
        } else if (
